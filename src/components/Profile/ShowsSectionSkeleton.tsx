  ...
  return (
    <div className="flex flex-col gap-3 md:gap-5">
      <div className="flex flex-wrap items-center justify-between gap-4 border-b border-white/10 pb-1 md:mt-5">
        <div className="bg-surface h-5 w-16 animate-pulse rounded" />
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <div className="flex items-center gap-1">
            <div className="bg-surface h-5 w-5 animate-pulse rounded" />
            <div className="bg-surface h-5 w-5 animate-pulse rounded" />
          </div>
        </div>
      </div>

      <div className="grid grid-cols-[repeat(3,minmax(0,1fr))] gap-3 sm:grid-cols-[repeat(4,minmax(0,1fr))] md:grid-cols-[repeat(6,minmax(0,1fr))] lg:grid-cols-[repeat(8,minmax(0,1fr))] xl:grid-cols-[repeat(11,minmax(0,1fr))]">
